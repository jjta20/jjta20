...
👨‍🏫 Profesor de Formación Profesional en la especialidad de Informática en el **IES Arcipreste de Hita**, situado en Azuqueca de Henares, Guadalajara.
...
- 💬 Puedes preguntarme sobre Python, Linux, redes, Git, desarrollo de software, inteligencia artificial o Formación Profesional.
- ⚡ Estoy convencido de que comprender los fundamentos sigue siendo la mejor manera de aprovechar la inteligencia artificial.
...
- 🐍 Programación y desarrollo de software con Python.
- 🧪 Pruebas, depuración y buenas prácticas de programación.
- 🌐 Administración de servicios en red sobre Linux.
- 🖥️ Sistemas operativos GNU/Linux.
- ☁️ Virtualización y creación de entornos de laboratorio.
- 🤖 Inteligencia artificial y aprendizaje automático.
- 📚 Aplicación de la inteligencia artificial a la educación.
- 🔧 Automatización de tareas mediante scripts.
- 🌱 Software libre y tecnologías abiertas.
- 👨‍🏫 Metodologías prácticas para la enseñanza de la informática.

---

## 📚 Módulos profesionales que imparto

### Sistemas Microinformáticos y Redes

- **Servicios en Red**
- Administración de servicios sobre Ubuntu Server.
- Configuración de redes y entornos cliente-servidor.
- Servicios DHCP, DNS, web, transferencia de archivos y acceso remoto.
...
- Uso de entornos de desarrollo, depuración, pruebas y documentación.

### Inteligencia Artificial y Big Data

- **Modelos de inteligencia artificial**
- Fundamentos de los sistemas de inteligencia artificial.
- Preparación y análisis de datos.
- Creación, entrenamiento y evaluación de modelos.
...
Si compartimos interés por la docencia, el software libre, la programación, las redes o la inteligencia artificial, estaré encantado de conectar contigo.

- 💼 Profesor de Formación Profesional en la especialidad de Informática.
